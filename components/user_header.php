...
<header class="header">
   ...
   <nav class="navbar nav-1">
      <section class="flex">
         <a href="home.php" class="logo"><i class="fas fa-house"></i>Home</a>

         <ul>
            <li><a href="post_property.php">post land<i class="fas fa-paper-plane"></i></a></li>
         </ul>
      </section>
   </nav>
            ...
            <ul>
               <li><a href="#">my listings<i class="fas fa-angle-down"></i></a>
                  <ul>
                     ...
                     <li><a href="post_property.php">post land</a></li>
